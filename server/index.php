    ...
    <div class="container">
    	<center>
	    	<div class="blog-header">
			    <img src="../assert/img/lgo.png" width="100px;" style="margin: 8px;">
				<marquee behavior="alternate"><h3 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;"><b>Selamat datang di Universitas Pelita Bangsa !</b></h3>  </marquee>
		    </div>
	    </center>
      	<div class="row loket">
      	</div>
      ...
      <footer class="footer">
        <center><p>&copy; Universitas Pelita Bangsa <?php echo date("Y");?></p></center>
      </footer> 
    </div>
  	</body>
